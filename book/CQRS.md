...
- Enables to build highly specialized (and therefore fast) read models while
  not prescribing a certain storage solution
...
- Jim Webber, Savas Parastatidis, Ian Robinson: REST in Practice: Hypermedia and Systems Architecture  
  <https://amzn.to/4pjwKCT>
